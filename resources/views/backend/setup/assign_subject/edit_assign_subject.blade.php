      ...
      <div class="row">
        ...
        <section class="col-md-12">
          ...
          <div class="card">
            ...
            <div class="card-body">
              <form method="post" action="{{ route('setups.student.assign.subject.update', $editData[0]->class_id) }}" id="myForm" enctype="multipart/form-data">
                @csrf
                <div class="add_item">
                  <div class="form-row">
                  ...
                  <div class="delete_whole_extra_item_add" id="delete_whole_extra_item_add">
                    <div class="form-row">
                      ...
                      <div class="form-group col-md-2">
                        ...
                        <input type="text" name="full_mark[]" value="{{ $data->full_mark }}" class="form-control" required>
                      </div>
                      <div class="form-group col-md-2">
                        <label for="amount">Pass Mark</label>
                        <input type="text" name="pass_mark[]" value="{{ $data->pass_mark }}" class="form-control" required>
                      </div>
                      <div class="form-group col-md-2">
                        <label for="amount">Subjective Mark</label>
                        <input type="text" name="subjective_mark[]" value="{{ $data->subjective_mark }}" class="form-control" required>
                      </div>
