        ...
        <div class="col-md-12">
          <table width="100%">
            <tr>
              ...
              <td width="25%" class="text-center"> <img src="{{ url('public/upload/student_images/'. $details->student->image) }}" alt="" style="width:100px; height:100px;"> </td>
            </tr>
          </table>
        </div>
        <div class="col-md-12 text-center">
          <h5 style="font-weight:bold; padding-top:-25px; text-align:center;">Student Details Information</h5>
        </div>
        <div class="col-md-12">
