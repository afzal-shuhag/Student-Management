    ...
    <div class="container">
      <div class="row">
        <div class="col-md-12">
          <table width="100%">
            @php
            $examFee = App\Model\FeeAmount::where('fee_category_id','3')->where('student_class_id', $details->class_id)->first();
        ...
        <div class="col-md-12 text-center">
          <h5 style="font-weight:bold; padding-top:-25px; text-align:center;">Student Exam Fee</h5>
        </div>
        <div class="col-md-12">
