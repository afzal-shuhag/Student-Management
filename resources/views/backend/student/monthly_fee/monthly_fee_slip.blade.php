    ...
    <div class="container">
      <div class="row">
        <div class="col-md-12">
          <table width="100%">
            @php
            $monthlyFee = App\Model\FeeAmount::where('fee_category_id','2')->where('student_class_id', $details->class_id)->first();
        ...
        <div class="col-md-12 text-center">
          <h5 style="font-weight:bold; padding-top:-25px; text-align:center;">Student Monthly Info</h5>
        </div>
        <div class="col-md-12">
          <table border="1" width="100%">
            <tbody>
              ...
              <tr>
                <td style="width:50%;">Final Fee</td>
                <td>{{ $finalfees }} TK</td>
              </tr>
            </tbody>
          </table>
