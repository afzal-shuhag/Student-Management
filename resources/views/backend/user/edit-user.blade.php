              ...
              <form method="post" action="{{ route('users.update',$editData->id) }}" id="myForm">
                ...
                <div class="form-row">
                  <div class="form-group col-md-4">
                    ...
                    <select class="form-control" name="role_two">
                      <option value="">Select Role 2</option>
                      <option value="Admin" {{ ($editData->role_two == "Admin") ? 'selected' : '' }}>Admin</option>
                      <option value="Operator" {{ ($editData->role_two == "Operator") ? 'selected' : '' }}>Operator</option>
                    </select>
                    <font style="color:red;">{{ ($errors->has('role_two')) ? ($errors->first('role_two')) : '' }}</font>
                  </div>
                  <div class="form-group col-md-4">
